...
\begin{table}[htb]
	...
	\begin{tabular}{|c|c|c|c|c|}
		...
		\hline
	\end{tabular}
	\caption{Data yields and background predictions with errors for l\tau and \tau\tau channels. \label{d&b} }
\end{table}
 
In particle physic, sigma is used to represent standard deviation. Standard deviation measures the distribution of data points around a mean, or average, and can be thought of as how "wide" the distribution of points or values is. A sample with a high standard deviation is more spread out—it has more variability, and a sample with a low standard deviation clusters more tightly around the mean. The graph\ref{brazil} below shows the the upper limit of $\sigma/\sigma_{pp \rightarrow W\primeW\prime}$ production in $\pm\sigma$.
...
\caption{Upper limit of $\sigma/\sigma_{pp \rightarrow W\primeW\prime}$ production }
\label{fig:brazil}
\end{figure}
